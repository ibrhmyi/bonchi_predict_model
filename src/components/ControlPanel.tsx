    ...
    <section className="rounded-4xl border border-white/70 bg-white/80 p-6 shadow-panel backdrop-blur xl:p-8">
      <div className="space-y-2">
        ...
        <p className="text-sm leading-6 text-stone">
          Choose a country, lock the gelato base, then rank fruit concepts with a preset or custom weights.
        </p>
      </div>
      ...
      <div className="mt-8 space-y-6">
        ...
        <label className="block space-y-2">
          <span className="text-sm font-medium text-ink">Gelato base</span>
          <select
